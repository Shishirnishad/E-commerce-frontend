...
function CustomerLogin({ onLogin }) {
  ...
  const handleSendOtp = async () => {
    ...
    setForgotMsg(null);
    try {
      const res = await axios.post(`${REACT_APP_BASE_API_URL}/customer/sendotp`, {
        email: forgotEmail,
      });
  ...
  const handleVerifyOtp = async () => {
    ...
    setForgotMsg(null);
    try {
      const res = await axios.post(`${REACT_APP_BASE_API_URL}/customer/verifyotp`, {
        email: forgotEmail,
        otp,
      });
      setForgotMsg({ type: "success", text: res.data });
  ...
  const handleResetPassword = async () => {
    ...
    setForgotMsg(null);
    try {
      const res = await axios.put(`${REACT_APP_BASE_API_URL}/customer/resetpassword`, {
        email: forgotEmail,
        password: newPass,
      });
      setForgotMsg({ type: "success", text: res.data });
